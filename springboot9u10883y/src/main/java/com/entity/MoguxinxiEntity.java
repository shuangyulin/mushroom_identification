 ...
 */
@TableName("moguxinxi")
public class MoguxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public MoguxinxiEntity() {
		
	}
	
	public MoguxinxiEntity(T t) {
		try {
	 ...
	 * 设置：蘑菇名称
	 */
	public void setMogumingcheng(String mogumingcheng) {
		this.mogumingcheng = mogumingcheng;
	}
	/**
	 * 获取：蘑菇名称
	 */
	public String getMogumingcheng() {
		return mogumingcheng;
	}
	/**
	 * 设置：蘑菇分类
	 */
