<template>
	<div :style='{"padding":"0 0 20px","margin":"0px auto","color":"#666","background":"#fff","width":"1200px","fontSize":"16px","position":"relative"}'>
		<div class="section-title" :style='{"padding":"0","margin":"20px 0","color":"#000","textAlign":"center","background":"#fff","width":"110%","lineHeight":"60px","fontSize":"30px","order":"0"}'>留言反馈</div>
