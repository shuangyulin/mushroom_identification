<template>
	...
	<div class="section-title" :style='{"padding":"0","margin":"20px 0","color":"#000","textAlign":"center","background":"#fff","width":"110%","lineHeight":"60px","fontSize":"30px","order":"0"}'>我的发布</div>
