<template>
	<div :style='{"padding":"0 0 20px","margin":"0px auto","color":"#666","background":"#fff","width":"1200px","fontSize":"16px","position":"relative"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0","margin":"20px 0","color":"#000","textAlign":"center","background":"#fff","width":"110%","lineHeight":"60px","fontSize":"30px","order":"0"}'>我的收藏</div>
