<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"70px 0 0 200px","margin":"0","position":"relative","background":"#E3E8F4","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 0px 0px rgba(0, 0, 0, .3)","padding":"0 20px 0","alignItems":"center","color":"#fff","display":"flex","justifyContent":"flex-end","top":"0","left":"0px","background":"#A40000","width":"calc(100% - 0px)","fontSize":"16px","position":"fixed","zIndex":"1001","height":"70px"}'></index-header>
