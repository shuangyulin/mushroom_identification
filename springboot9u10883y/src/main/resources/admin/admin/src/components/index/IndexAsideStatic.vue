...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item:hover {
		padding: 0 20px 0 56px !important;
		color: #fff !important;
		background: url(http://codegen.caihongy.cn/20240907/b22a4847ab514672b48bac0bf46c4c1a.png) no-repeat center center / 90% 100% !important;
		width: 100% !important;
		line-height: 40px !important;
		height: 40px !important;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
		padding: 0 20px 0 56px;
		color: #fff;
		background: url(http://codegen.caihongy.cn/20240907/b22a4847ab514672b48bac0bf46c4c1a.png) no-repeat center center / 90% 100%;
		width: 100%;
		line-height: 40px;
		height: 40px;
	}
