<template>
	<div class="main-content" :style='{"width":"100%","padding":"20px 30px","fontSize":"15px"}'>
		...
		<div v-if="!showFlag" style="width: 100%;">
			<el-form :style='{"border":"20px solid #fff","margin":"0 0px 0px","flexWrap":"wrap","background":"#E3E8F4","display":"flex","width":"100%","justifyContent":"space-between"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}'>
					...
					<el-button class="search" :style='{"border":"0","cursor":"pointer","padding":"0 10px","color":"#fff","borderRadius":"4px","background":"#A40000","width":"auto","fontSize":"16px","height":"34px"}' type="success" @click="search()">
				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"0px solid #157ed2","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","color":"#fff","borderRadius":"4px","background":"#24BF74","width":"auto","fontSize":"14px","height":"32px"}'
								size="small"
